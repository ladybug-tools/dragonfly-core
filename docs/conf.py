...
latex_documents = [
    (master_doc, 'dragonfly.tex', 'dragonfly-core Documentation',
...
man_pages = [
    (master_doc, 'dragonfly', 'dragonfly-core Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dragonfly', 'dragonfly-core Documentation',
     author, 'dragonfly-core', 'One line description of project.',
     'Miscellaneous'),
]
